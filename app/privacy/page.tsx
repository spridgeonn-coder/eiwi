        ...
        <div className="space-y-10 text-zinc-400 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-2">
              ...
              <li><span className="text-zinc-300 font-medium">GitHub access token</span> — a token that allows us to read your repositories on your behalf, stored securely in our database</li>
              <li><span className="text-zinc-300 font-medium">Repository code</span> — the contents of files in repositories you choose to analyze, sent to our AI provider for analysis</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-3 ml-2">
              <li>
                <span className="text-zinc-300 font-medium">Supabase</span> — we use Supabase to store your account information, GitHub tokens, and analysis results. Data is stored on secure servers. See <a href="https://supabase.com/privacy" className="text-violet-400 hover:underline" target="_blank" rel="noopener noreferrer">Supabase's Privacy Policy</a>.
              </li>
              <li>
                <span className="text-zinc-300 font-medium">OpenAI</span> — when you run a code analysis, the contents of your repository files are sent to OpenAI's API to generate the analysis. OpenAI may use this data according to their policies. See <a href="https://openai.com/privacy" className="text-violet-400 hover:underline" target="_blank" rel="noopener noreferrer">OpenAI's Privacy Policy</a>.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2 ml-2">
              ...
              <li>File contents are sent to OpenAI solely for the purpose of generating analysis</li>
              <li>Analysis results are stored in our database and associated with your account</li>
          ...
          <section>
            ...
            <p>We retain your account information and analysis history for as long as your account is active. If you delete your account, we will delete your personal data and analysis history within 30 days. Your GitHub access token can be revoked at any time through your GitHub account settings, which will prevent us from accessing your repositories going forward.</p>
          </section>

          <section>
            <h2 className="text-white font-semibold text-lg mb-3">7. Data Security</h2>
            <p>We implement reasonable security measures to protect your information, including encrypted storage of GitHub tokens and secure HTTPS connections. However, no method of transmission or storage is 100% secure, and we cannot guarantee absolute security.</p>
          </section>
